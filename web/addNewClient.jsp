        ...
        <c:if test="${clientType == 'individual'}">
            ...
            <c:if test="${not empty errors}">
                <c:forEach var="error" items="${errors}">
                    <p class="text-danger"><c:out value="${error.value}"/><br></p>
                </c:forEach>
            </c:if>
            <form method="post" action="AddClientServlet">
                ...
                <a href="/ShowContractsServlet" class="btn btn-danger">Home</a>
            </form>
        </c:if>
        <c:if test="${clientType == 'legalEntity'}">
            ...
            <form method="post" action="AddClientServlet">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="addressOrganization" name="address">
                </div>
